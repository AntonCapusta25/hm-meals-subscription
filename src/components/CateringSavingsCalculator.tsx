            ...
            <div className="container mx-auto px-5 relative z-10 max-w-7xl">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-6xl font-heading font-bold text-dark mb-4 leading-tight">
                        See how much your team<br />
                        <span className="text-orange">could save</span>
                    </h2>
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Compare the cost of restaurant catering vs. Homemade catering. Adjust the sliders to match your setup.
                    </p>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-10 items-start max-w-6xl mx-auto">
                    ...
                    >
                        <h3 className="text-2xl font-heading font-bold text-dark mb-8">Configure your event</h3>

                        {/* Meal type selector */}
                        <div className="mb-8">
                            <label className="block text-sm font-bold text-gray-500 uppercase tracking-widest mb-3">Event type</label>
                        ...
                        <div className="mb-8">
                            <div className="flex justify-between items-end mb-3">
                                <label className="text-sm font-bold text-gray-500 uppercase tracking-widest">Number of guests</label>
                        ...
                        <div className="mb-2">
                            <div className="flex justify-between items-end mb-3">
                                <label className="text-sm font-bold text-gray-500 uppercase tracking-widest">Events per year</label>
                        ...
                        <div className="mt-8 p-4 rounded-2xl bg-gray-50 border border-gray-100 text-sm text-gray-500 leading-relaxed">
                            <p>💡 Based on average Amsterdam restaurant catering rates vs. Homemade's transparent pricing. Actual savings may vary.</p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="bg-[#1A2D20] rounded-3xl p-8 md:p-10 text-white relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <p className="text-white/70 font-medium mb-2 text-lg">You could save</p>
                                <motion.div
                                    key={savings}
                                ...
                                <p className="text-white/70 font-medium mb-8 text-lg">per year · {savingsPct}% less than restaurants</p>

                                <div className="w-full h-px bg-white/10 mb-8" />

                                <div className="grid grid-cols-2 gap-6">
                                    <div>
                                        <p className="text-white/60 text-sm font-medium mb-1">Per event saving</p>
                                        <p className="font-heading font-bold text-2xl">{formatEur(perEventSaving)}</p>
                                    </div>
                                    <div>
                                        <p className="text-white/60 text-sm font-medium mb-1">Over 5 years</p>
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                            <h4 className="font-heading font-bold text-dark mb-6 text-lg">Annual cost breakdown</h4>
                            <div className="space-y-4">
                                {/* Restaurant */}
                                <div>
                                    <div className="flex justify-between items-center mb-1.5">
                                        <span className="text-sm font-medium text-gray-500">Restaurant catering</span>
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-1.5">
                                        <span className="text-sm font-medium text-gray-500">Homemade catering</span>
